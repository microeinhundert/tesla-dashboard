...
<div class="travel-info-container">
  ...
  <div class="l-container l-left">
    ...
    <div class="cruise-status-icon h-center-text" :class="{ 'is-active' : cruiseControl.isActive }">
      <span v-if="cruiseControl.isActive" class="cruise-mode">Max</span>
